...
# --- تنسيق الواجهة لتكون خانة الكتابة بالأسفل ---
st.markdown("""
    <style>
    /* محاذاة النص للعربية */
